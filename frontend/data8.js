...
/* ===================== 审讯质询·破绽点（V9.2+ 探案创意） ===================== */
/* 玩家通过自由问句挖出"破绽点"，累积到阈值才可标记骗子/揭露。
 * 关键词命中 → 该破绽点 +1（不重复累积）→ AI 知道当前破绽进度 → 表现更精准。 */
const INTERROGATION = {
  threshold: 3,
  breaks: {
    zhanghao: [
      { id: "zh_payoff", label: "收益异常", keywords: ["收益","赚","回报","分红","年化","稳赚","几倍","翻倍"] },
      { id: "zh_company", label: "公司资质存疑", keywords: ["公司","注册","执照","地址","你在哪","你是谁","真名"] },
      { id: "zh_transfer", label: "要求转账", keywords: ["转账","打款","账户","银行卡","先付","押金","手续费"] },
      { id: "zh_urgency", label: "制造紧迫感", keywords: ["今天","马上","截止","过期","错过","来不及","最后"] },
    ],
    lijie: [
      { id: "lj_return", label: "晒收益截图", keywords: ["赚了","到账","提现","收益","已到","翻倍"] },
      { id: "lj_company", label: "公司信息", keywords: ["公司","地址","你是谁","真名","注册"] },
      { id: "lj_pay", label: "代付/垫付", keywords: ["先付","转账","押金","手续费","垫付","帮忙付"] },
    ],
    xiaoyun: [
      { id: "xy_emotion", label: "情感操控", keywords: ["喜欢","爱","信任","只有你","懂你","陪我"] },
      { id: "xy_meetup", label: "线下见面", keywords: ["见面","来找你","地址","酒店","出来"] },
      { id: "xy_money", label: "提到钱", keywords: ["借","周转","急用","投资","项目","充值"] },
    ],
    xiaoya: [
      { id: "xy_lost", label: "已投金额", keywords: ["3万","五万","投了","亏了","完了"] },
      { id: "xy_trace", label: "转账去向", keywords: ["转到","账户","平台","app","app里"] },
    ],
  },
};
